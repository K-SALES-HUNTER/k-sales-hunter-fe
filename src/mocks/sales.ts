...
export const salesOpsMock = {
  ...
  performance: {
    ...
    monthlyRevenue: [
      { label: '6월', revenue: 433_500, profit: 125_100 },
      { label: '7월', revenue: 1_127_100, profit: 325_260 },
      { label: '8월', revenue: 1_011_500, profit: 291_900 },
    ],
  ...
  priceManage: {
    ...
    /** 가격 조정 판단 근거 한 줄 */
    note: '현재 가격은 현지 프리미엄 구간의 하단입니다. 정품 포지션을 지키면서 마진율을 방어하려면 ₩28,900 유지가 가장 안전합니다.',
    impacts: [
      { price: '₩26,900', margin: '24.1%', impact: '판매량 +8% 예상', verdict: '테스트 가능' },
      { price: '₩28,900', margin: '28.9%', impact: '현재 판매 가격', verdict: '추천' },
      { price: '₩31,900', margin: '34.9%', impact: '판매량 -12% 예상', verdict: '신중' },
    ] as PriceImpactRow[],
    history: [
      { date: '2026-08-03', before: '₩26,900', after: '₩28,900' },
      { date: '2026-07-12', before: '₩24,900', after: '₩26,900' },
      { date: '2026-06-15', before: '—', after: '₩24,900' },
    ] as PriceHistoryRow[],
  },
} as const;

 ...
 * 누적 210개 · 매출 ₩4,158,000 · 순이익 ₩1,176,000 (개당 순이익 ₩5,600)
...
export const dashboardSummaryMock: DashboardSummary = {
  ...
  monthlyRevenue: [
    { month: '6월', value: 380000 },
    { month: '7월', value: 396000 },
    { month: '8월', value: 400000 },
  ],
};

/**
 * [DEMO-ONLY] 인형의 베트남 판매까지 시작한 뒤의 요약 — 기존 실적 + 인형 실적 합산.
 *   립틴트 매출 ₩4,158,000 / 순이익 ₩1,176,000 (기존)
 * + 인형   매출 ₩2,572,100 / 순이익 ₩742,260 (판매 관리와 같은 원장)
 * = 매출 ₩6,730,100 / 순이익 ₩1,918,260 · 주문 244건 · 판매 중 상품 2개
...
export const dashboardSummaryAfterSalesMock: DashboardSummary = {
  ...
  monthlyRevenue: [
    { month: '6월', value: 505100 },
    { month: '7월', value: 721260 },
    { month: '8월', value: 691900 },
  ],
};
